            ...
            <div className='w-50 shadow p-3 mb-5 bg-body rounded ' style={{ backgroundColor: '#ffffff' }}>
                <div className='w-75 m-3'>
                    ...
                    <div className="mb-3 ">
                        ...
                        <input type="email" name='email' onChange={handleUser} className="form-control p-4" id="exampleFormControlInput1" placeholder="email" />
                    </div>
                    <div className="mb-3">
                ...
                <Link to='/reg'>Create A New Account?</Link>
            </div>
        </div>
    )
}
